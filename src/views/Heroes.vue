      ...
      <div class="inner">
        <loader :loading="loading">
                ...
                <div class="w3-card w3-row w3-padding">
                  ...
                  <div class="w3-rest w3-padding-small">
                    <b style="line-height: 40px; color:#25a2c3">
                      ...
                      <div :style="'background-color:#f6755e;color:white !important;height:32px;width:'+ Math.round(item.total.winRate * 100)+'%'">
          ...
          <p>
            ...
            It has dumbbells that connect the <b style="color:black !important">Previous</b> week and the <b style="color: #f6755e">Current</b> week.
          </p>
        </loader>
