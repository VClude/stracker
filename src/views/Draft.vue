        ...
        <div class="inner">
          <loader :loading="loading">
            ...
            <template v-for="(attribute) in hero.attributes">
              <div v-bind:key="attribute.name">
                <div class="w3-row-padding">
                  ...
                  <div class="w3-third">
                    <div class="w3-border">
                      <div :style="'background-color:#f6755e;color:white !important;height:24px;width:'+ Math.round(attribute.percentage * 100)+'%'"></div>
                    </div>
                  </div>
                  <div class="w3-third">
                    {{attribute.value}}
            ...
            <p>
              ...
              <b style="color:black !important">Highlighted</b> talents are dependent on the hero's default abilities.
            ...
            <template v-for="(talents, key) in hero.talents">
              <div class="w3-row-padding w3-center" v-bind:key="key">
                ...
                <div class="w3-col s2">
                  <span class="w3-tag w3-round-large" style="background-color:#f6755e;color:white !important;">{{key}}</span>
                </div>
                <div class="w3-col s1">
            ...
            <div class="w3-center">
              <b style="color:black !important">Sort By</b>
              <div>
            ...
            <div class="w3-row-padding">
              <template v-for="(item) in sortedCombos">
                <div v-bind:key="item.id" class="w3-col s1" style="position: relative;">
                  ...
                  <span class="w3-tag w3-round w3-small" style="position: absolute; top:-5px;left:0px;background-color:#f6755e;color:white !important;">{{Math.round(item.winRate * 100)}}%</span>
                  <span v-if="item.hasUpgrade" class="w3-tag w3-round w3-small" style="position: absolute; top:-5px;right:5px;background-color:#25a2c3;">
                    <img src="http://localhost/APImock/mics/aghanims_scepter_upgrade.png" class="aghanims_scepter" />
                  </span>
                </div>
              </template>
            </div>
              ...
              <template v-for="(item) in sortedDraft">
                <div v-bind:key="item.ability.id" class="w3-row-padding">
                  <div class="w3-col s1" style="position: relative;">
                    ...
                    <span class="w3-tag w3-round w3-small" style="position: absolute; top:-5px;left:0px;background-color:#f6755e;color:white !important;">{{Math.round(item.ability.winRate * 100)}}%</span>
                    ...
                    <loader :small="true" :loading="item.loading">
                      <template v-for="(combo) in item.sortedCombos">
                        <div v-bind:key="combo.id" class="w3-col s1" style="position: relative;">
                          ...
                          <span class="w3-tag w3-round w3-small" style="position: absolute; top:-5px;left:-5px;background-color:#f6755e;color:white !important;">{{Math.round(combo.winRate * 100)}}%</span>
