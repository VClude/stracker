        ...
        <div class="inner">
          <div>
            <p>
              ...
              Some abilities of heroes are <b style="color:black !important;">Disabled</b> and highlighted as such, this includes scepter upgrades.
              Abilities marked by <img class="ability-icon-xs" src="http://localhost/APImock/mics/aghanims_scepter_upgrade.png" /> are upgraded or granted by Aghanim's Scepter.
                    ...
                    <div v-if="hero.enabled" style="height: 250px;">
                      <template v-for="(ability) in hero.abilities">
                        <div v-bind:key="ability.id" class="truncate" style="line-height: 25px; padding: 5px;">
                          ...
                          <img v-if="ability.hasUpgrade" class="ability-icon-xs" src="http://localhost/APImock/mics/aghanims_scepter_upgrade.png" style="vertical-align: middle;" />
                          <img v-if="ability.isGranted" class="ability-icon-xs" src="http://localhost/APImock/mics/aghanims_scepter_granted.png" style="vertical-align: middle;" />
